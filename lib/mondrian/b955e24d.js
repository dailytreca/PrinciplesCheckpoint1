...
`),fn=[{icon:gn,value:"improve",text:"Improve writing"},{icon:en,value:"proofread",text:"Fix spelling and grammar"},{icon:an,value:"shorten",text:"Make shorter"},{icon:on,value:"lengthen",text:"Make longer"},{icon:dn,value:"changeTone",text:"Change tone",submenu:[{value:"changeTone_professional",text:"Professional"},{value:"changeTone_casual",text:"Casual"},{value:"changeTone_straightforward",text:"Straightforward"},{value:"changeTone_confident",text:"Confident"},{value:"changeTone_friendly",text:"Friendly"},{value:"changeTone_custom",text:"Custom"}]},{icon:mn,value:"changeAudience",text:"Change audience"},{icon:ln,value:"simplify",text:"Simplify Writing"}],bn=[{icon:Xo,value:"boldKeyTerms",text:"Bold key terms"},{icon:hn,value:"addEmojis",text:"Add emojis"}],Sn=[{icon:rn,value:"continue",text:"Continue writing"},{icon:pn,value:"explain",text:"Explain this"},{icon:pn,value:"suggestImprovements",text:"Suggest improvements"},{icon:pn,value:"findSynonyms",text:"Find synonyms"},{icon:pn,value:"createAnalogy",text:"Create an analogy"},{icon:pn,value:"createScenario",text:"Create a scenario"},{icon:pn,value:"createKeyTakeaways",text:"Create key takeaways"},{icon:pn,value:"createImagePrompt",text:"Create an AI image prompt"}],Cn=[{icon:pn,value:"createHaiku",text:"Write a haiku"}],In=[{icon:pn,value:"writeAboutTopic",text:"Write about..."},{icon:pn,value:"write1ParagraphAboutTopic",text:"Write 1 paragraph"},{icon:pn,value:"write2ParagraphsAboutTopic",text:"Write 2 paragraphs"},{icon:pn,value:"write3ParagraphsAboutTopic",text:"Write 3 paragraphs"}],wn=[{icon:Ko,value:"replace",text:"Replace selection"},{icon:Uo,value:"append",text:"Insert below"},{icon:Wo,value:"copy",text:"Copy"},{icon:rn,value:"continue",text:"Continue writing"},{icon:un,value:"discard",text:"Cancel"}],yn=[{icon:nn,value:"retry",text:"Try again"},{icon:un,value:"discard",text:"Cancel"}],xn={improve:{option:"improve"},proofread:{option:"proofread"},lengthen:{option:"lengthen"},shorten:{option:"shorten"},changeTone_professional:{option:"changeTone",params:{tone:"professional"}},changeTone_casual:{option:"changeTone",params:{tone:"casual"}},changeTone_straightforward:{option:"changeTone",params:{tone:"straightforward"}},changeTone_confident:{option:"changeTone",params:{tone:"confident"}},changeTone_friendly:{option:"changeTone",params:{tone:"friendly"}},changeTone_custom:{option:"changeTone"},changeAudience:{option:"changeAudience"},simplify:{option:"simplify"},copy:{option:"copy"},append:{option:"append"},replace:{option:"replace"},continue:{option:"continue"},discard:{option:"discard"},retry:{option:"retry"},boldKeyTerms:{option:"boldKeyTerms"},addEmojis:{option:"addEmojis"},explain:{option:"explain"},suggestImprovements:{option:"suggestImprovements"},findSynonyms:{option:"findSynonyms"},createAnalogy:{option:"createAnalogy"},createScenario:{option:"createScenario"},createKeyTakeaways:{option:"createKeyTakeaways"},createImagePrompt:{option:"createImagePrompt"},createHaiku:{option:"createHaiku"},writeAboutTopic:{option:"writeAboutTopic"},write1ParagraphAboutTopic:{option:"write1ParagraphAboutTopic"},write2ParagraphsAboutTopic:{option:"write2ParagraphsAboutTopic"},write3ParagraphsAboutTopic:{option:"write3ParagraphsAboutTopic"}};let kn=class extends Go{constructor(){super(...arguments),this.menu="initial",this.submenuAnchor=this,this.handleMenuSubmit=e=>{const{detail:t}=e,a=xn[t.value];a&&this.dispatchEvent(new CustomEvent("canned-option:submit",{detail:a}))},this.handleSubmenuTriggerClick=(e,t)=>{e.currentTarget instanceof HTMLElement&&(this.selected!==t?(this.selected=t,this.submenuAnchor=e.currentTarget):this.closeSubmenu())},this.openSubmenu=e=>{this.selected!==e.detail.value&&(this.selected=e.detail.value,this.submenuAnchor=e.detail.target)},this.closeSubmenu=()=>{this.selected=void 0,this.submenuAnchor=this},this.onMenuEscape=()=>{this.selected&&(this.selected=void 0,this.submenuAnchor=this)}}render(){return Ho.qy`
    ...
    `}renderReplyMenuOptions(){return"reply"!==this.menu?Ho.s6:Ho.qy`
      ${this.renderMenuItemGroup(wn)}
      ${this.renderEditSelectionsOptions()}
      ${this.renderFormatSelectionOptions()}
    `}renderScratchMenuOptions(){return"scratch"!==this.menu?Ho.s6:this.renderScratchOptions()}renderCanceledMenuOptions(){return"canceled"!==this.menu?Ho.s6:Ho.qy`${this.renderMenuItemGroup(yn)}`}renderEditSelectionsOptions(){return Ho.qy`
...
`;let $n=class extends(Pn(Go)){constructor(){super(...arguments),this.offset=12,this.positionConfig={middleware:[(0,Mn.cY)(this.offset)]},this.stopMouseEventPropagation=!1,this.inputRef=(0,Ln._)(),this.resultsMutationObserver=new MutationObserver((()=>{const e=this.$(".response");e&&e.scrollTo(0,e.scrollHeight)})),this.handleInputSubmit=e=>{e.preventDefault(),this.submitInput()},this.handleCannedOptionSelect=e=>{this.handleCannedOption(e.detail)},this.maybeStopPropagation=e=>{this.stopMouseEventPropagation&&this.stopPropagation(e)},this.stopPropagation=e=>{e.stopPropagation()},this.handleBlur=e=>{this.dispatchEvent(new CustomEvent("blur"))},this.handlePaginationClick=e=>{const t=e.currentTarget;"decrement"===t.name&&this.decrementResponseIndex(),"increment"===t.name&&this.incrementResponseIndex(),this.status="prompt"}}get isGenerating(){return["pending","streaming"].includes(this.status)}willUpdate(e){const t=e.get("status"),a=this.status,i=this.$(".response");i&&("streaming"!==t&&"streaming"===a&&this.resultsMutationObserver.observe(i,{subtree:!0,childList:!0}),"streaming"===t&&"prompt"===a&&this.resultsMutationObserver.disconnect())}renderSubmitButton(){if(!this.isGenerating){const e=this.userInput.length<=0;return Ho.qy`
    ...
    `}firstUpdated(e){super.firstUpdated(e),window.requestAnimationFrame((()=>{this.inputRef.value&&this.inputRef.value.focus({preventScroll:!0})}))}renderCannedOptionMenu(){if(!this.isGenerating)return Ho.qy`
